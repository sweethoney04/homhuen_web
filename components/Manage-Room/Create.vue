<template>
  <v-dialog v-model="show" max-width="500px">
    ...
    <v-card>
      <v-card-title>
        <span class="text-h6">ເພີ່ມຫ້ອງ</span>
      </v-card-title>
      ...
      <v-card-text>
        <v-container>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              <v-text-field v-model="form.roomName" label="ຊື່ຫ້ອງ"></v-text-field>
            </v-col>

            <v-col cols="12" sm="6">
              <v-text-field v-model="form.type" label="ປະເພດ"></v-text-field>
            </v-col>
